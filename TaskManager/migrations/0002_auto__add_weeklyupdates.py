...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WeeklyUpdates'
        db.create_table(u'TaskManager_weeklyupdates', (
        ...
        db.send_create_signal(u'TaskManager', ['WeeklyUpdates'])


    def backwards(self, orm):
        # Deleting model 'WeeklyUpdates'
        db.delete_table(u'TaskManager_weeklyupdates')
    ...
    models = {
        ...
        u'TaskManager.weeklyupdates': {
            'Meta': {'object_name': 'WeeklyUpdates'},
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['TaskManager.Projects']"}),
