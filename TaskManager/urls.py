...
from TaskManager.views import LoginView,HomeView,ProjectsView,TasksView,TasksDetailView,TasksListView,TasksCreate,ProjectsCreate,ProfileView,TasksUpdateView
from TaskManager.views import ProjectsListView,ProjectsListView,ProjectsDetailView,MailView,OngoingProjectsView,CompletedProjectsView,ProfileDetailView
